...
<div class="content-wrapper">
  ...
  <section class="content" style="background-color:white;">
    ...
    <tbody>
        ...
        $query = mysqli_query($conn, "SELECT * FROM `management`  ORDER BY id DESC");
        ...
        while ($row = mysqli_fetch_array($query)) {
            ...
            <tr>
                ...
                if ($row['time_out'] == "") {
                    echo ' <a href="#" data-toggle="modal" class="btn btn-danger" name="button"> Not Completed </a> ';
                } else {
