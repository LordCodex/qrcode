        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
					<h5><center>Are you sure to delete <strong><?php echo ucwords($drow['firstname'].' '.$row['lastname'].' '.$row['othername']); ?></strong> from the list? This method cannot be undone.</center></h5> 
                </div> 
				</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<form method="POST" action="edit.php?id=<?php echo $erow['id']; ?>">
					...
					<div class="row">
						<div class="col-lg-2">
							<label style="position:relative; top:7px;">Othername:</label>
						</div>
						<div class="col-lg-10">
							<input type="text" name="othername" class="form-control" value="<?php echo $erow['othername']; ?>">
						</div>
					</div>
					...
					<div class="row">
						...
						<div class="col-lg-10">
							<input type="text" name="number" class="form-control" value="<?php echo $erow['number']; ?>">
						</div>
					</div>
